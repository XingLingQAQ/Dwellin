...
public class ConfigUpdater {
    ...
    public static void updateWithoutComments(Dwellin plugin,String fileName,File toUpdate){
     ...
     */
    public static void update(Dwellin plugin, String resourceName, File toUpdate, List<String> ignoredSections,boolean unregister) throws IOException {
    ...
    private static void write(FileConfiguration newConfig, FileConfiguration oldConfig, Map<String, String> comments, List<String> ignoredSections, BufferedWriter writer, Yaml yaml,Dwellin plugin,boolean unregister) throws IOException {
